...
function shopAluAngle(width,height,thick,len) {
    ...
    //properties
    this.inWidth = (10*(width) - 10*(thick))/10;
    this.inHeight = height - thick;
    console.log ("innerWidth: " + this.inWidth + ", innerHeight: " + this.inHeight);
...
function shopBkxx(diam){
    ...
    this.makeCsg = function() {
        ...
        var cylCutout = new CSG.cylinder({start: [-dimL1,0,dimh], end: [dimL,0,dimh], radius: diam/2, resolution:16});
