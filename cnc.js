...
//         sideBedCsg = sideBedCsg.union(sideBedCsg.translate([0,0,-baseObj.thickness - sideBedObj.thickness]));
    ...
    var xLinBearCsg = xLinBearObj.makeCsg();
        ...
        xLinBearCsg = xLinBearCsg.union(xLinBearCsg.rotateX(-90).translate([0,baseObj.width - 2*xRailAngObj.inWidth -2*(xRailObj.railZPos - xLinBearObj.railZPos),0])).center("y");
